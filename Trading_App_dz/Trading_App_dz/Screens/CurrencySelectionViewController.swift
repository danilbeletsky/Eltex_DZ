...
final class CurrencySelectionViewController: UIViewController {
    ...
    func makeConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            dataSourceSegmentedControl.heightAnchor.constraint(equalToConstant: 32),

            // Type Filter
            filterSegmentedControl.topAnchor.constraint(equalTo: dataSourceSegmentedControl.bottomAnchor, constant: 10),
    ...
    func updateFilteredItems() {
        ...
        switch typeIndex {
        case 1:
            typeFiltered = sourceItems.filter { fiatCurrencies.contains($0) }
        case 2:
            typeFiltered = sourceItems.filter { cryptoCurrencies.contains($0) }
        default:
            typeFiltered = sourceItems
        }
...
extension CurrencySelectionViewController: UICollectionViewDelegate {
    ...
    private func animateSelection(for indexPath: IndexPath) {
        ...
        UIView.animate(withDuration: 0.35, delay: 0, options: [.curveEaseInOut, .autoreverse]) {
            cell.contentView.backgroundColor = UIColor.systemGreen.withAlphaComponent(0.7)
        } completion: { _ in
